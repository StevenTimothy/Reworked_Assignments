...
/**
 * An abstact class that Uno-playing strategies implement in order to
...
public:
     ...
     */
	virtual int play(vector<Card> hand, Card upCard, Color calledColor, GameState state);
     ...
     */
    virtual Color callColor(vector<Card> hand);
};
#endif
